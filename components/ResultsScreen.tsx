...
const ResultsScreen: React.FC<ResultsScreenProps> = ({ questions, userAnswers, onPlayAgain, t }) => {
      ...
      <div className="mt-8">
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto ps-2">
          {questions.map((question, index) => {
            ...
            return (
              <div key={index} className={`p-4 rounded-lg border-2 ${isCorrect ? 'border-green-500/50 bg-green-500/10' : 'border-red-500/50 bg-red-500/10'}`}>
